...
const CONFIG = {
  ...
  timing: {
    ...
    introHoldSeconds: 5,       // כמה שניות מסך ההוראות נשאר לפני שהמשחק מתחיל
  ...
  tracks: [
    ...
    },
    {
      ...
      gameInstruction: 'בשני שלבים קצרים ומשימת סיום אחת, נראה איך אתם מזהים טעויות וחושבים כמו אנשי QA',
      ...
      resultMode: 'whatsapp',
      resultWhatsappCta: 'להמשך התהליך בוואטסאפ',
    ...
    },
    {
      ...
      gameInstruction: 'שתי שאלות קצרות ומשימת לוגיקה אחת יבדקו איך אתם חושבים, פועלים לפי תנאים ומתכננים רצף פעולות',
    ...
    },
    {
      ...
      gameInstruction: 'שתי החלטות קצרות ומשימת תקציב אחת יבדקו איך אתם מזהים קהל, מנתחים ביצועים ומקבלים החלטות שיווקיות',
    ...
    },
    {
      ...
      gameInstruction: 'שאלה קצרה ומשימת עיצוב אחת יבדקו איך אתם מזהים חוויה ברורה, מסדרים מידע ומתמקדים במה שהמשתמש באמת צריך',
    ...
    },
    {
      ...
      gameInstruction: 'החלטה אחת ומשימת מערכת קצרה יבדקו איך אתם מגיבים לתקלות, חושבים קדימה ושומרים על יציבות',
  ...
  advisor: {
    ...
    introTitle: 'רגע לפני שמחברים אתכם ליועץ לימודים',
    introText: 'עברתם בהצלחה את בדיקת ההתאמה. נשארו רק 3 שאלות קצרות שיעזרו לנו להתאים לכם את המסלול ואת השיחה בצורה מדויקת יותר.',
    introCta: 'ממשיכים לשאלות',
    about: [
      'לימודים מעשיים וממוקדי קריירה',
      'בשיתוף פעולה אקדמי עם אוניברסיטת אריאל',
      'ליווי אישי וסיוע במציאת עבודה לאחר הקורס',
    ],
    questions: [
      {
        key: 'start_when',
      ...
      {
        key: 'course_choice',
        q: 'איזה קורס הכי מעניין אתכם כרגע? 😉',
