  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showClose && (
          <DialogPrimitive.Close className="absolute left-4 top-4 rounded-lg p-1 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--course-primary,var(--brand-purple))]">
            <X className="size-4" />
